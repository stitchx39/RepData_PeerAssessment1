...
The mean is `r x1` and the median is `r y1`.
...
The maximum number of steps is `r z`.
...
The total number of missing values is `r z2`.
...
The old mean is `r x1` while the new mean is `r x2`.
The old median is `r y1` while the new median is `r y2`.
